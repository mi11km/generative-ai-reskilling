...
class TestCustomPromptTemplates:
    ...
    def test_create_custom_with_all_parameters(self):
        ...
        assert custom_templates.human_prompt == "カスタムヒューマン: {question} | {context}"
    ...
    def test_create_custom_with_partial_parameters(self):
        ...
        assert custom_templates.context_section_format == default_templates.context_section_format
        assert custom_templates.no_results_message == default_templates.no_results_message
...
@pytest.mark.parametrize("game_name,expected_type", [
