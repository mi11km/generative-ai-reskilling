...
class TestRAGServiceContainer:
    ...
    def test_get_or_create_rag_service_first_call(self, mock_rag_service_class, mock_settings, reset_container):
    ...
    @patch("src.api.chat.RAGService")
    def test_get_or_create_rag_service_caching(self, mock_rag_service_class, mock_settings, reset_container):
...
class TestRAGServiceContainerIntegration:
    ...
    def test_container_logging(self, mock_logger, mock_rag_service_class, mock_settings, reset_container):
    ...
    @patch("src.api.chat.RAGService")
    def test_container_thread_safety_simulation(self, mock_rag_service_class, mock_settings, reset_container):
...
class TestBackwardCompatibility:
    ...
    def test_api_endpoints_still_work(self, mock_container_class, client, reset_container):
