...
回答:"""
    ...
    no_results_message: str = (
        "申し訳ございません。お尋ねの内容に関する情報が仕様書内で見つかりませんでした。"
    )
...
class CustomPromptTemplates(PromptTemplates):
    ...
    def create_custom(
        ...
        return cls(
            ...
            context_section_format=context_section_format
            or default_templates.context_section_format,
            no_results_message=no_results_message
            or default_templates.no_results_message,
        )
